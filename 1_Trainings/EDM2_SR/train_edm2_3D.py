...
config_presets = {
    'edm2-3D-img224-SR':  dnnlib.EasyDict(duration=2048<<20, batch=2048, channels=64,  lr=0.0170, decay=35000, dropout=0.00, P_mean=-0.4, P_std=1.0),
}
#----------------------------------------------------------------------------
# Setup arguments for training.training_loop.training_loop().

def setup_training_config(preset='edm2-3D-img224-SR', **opts):
    ...
    # Dataset.
    c.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.Dataset_train_high_PETCT', 
...
@click.option('--preset',           help='Configuration preset', metavar='STR',                 type=str, default='edm2-3D-img224-SR', show_default=True)
