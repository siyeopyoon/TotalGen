...
config_presets = {
    'Flow-3D-img224-SR':  dnnlib.EasyDict(duration=2048<<20, batch=8, channels=64,  lr=0.001, decay=35000, dropout=0.00, P_mean=-0.4, P_std=1.0),
...
def setup_training_config(preset='Flow-3D-img224-SR', **opts):
...
@click.option('--preset',           help='Configuration preset', metavar='STR',                 type=str, default='Flow-3D-img224-SR', show_default=True)
