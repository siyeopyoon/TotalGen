    ...
    **sampler_kwargs,                           # Additional arguments for the sampler function.
    ...
    for Weight in Weight_Range:
        ...
        while current_start < D:
            ...
            out_extended = dnnlib.util.call_func_by_name(func_name=edm_sampler_conditional, net=srnet, noise=noise_partial, outfolder=outdir,
...
config_presets = {
    'cascade-EDM2-3D-img224':  dnnlib.EasyDict(net=f'{model_root}/EDM2_LowRes_network.pkl',
                                             srnet=f'{model_root}/EDM2_SR_network.pkl'),      # fid = 3.53=
    }



@click.command()
@click.option('--preset',                   help='Configuration preset', metavar='STR',                             type=str,  default='cascade-EDM2-3D-img224')
